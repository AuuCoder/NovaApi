export default {
  ...
  auth: {
    ...
    editorial: {
      volume: '第 {num} 期 / {year}',
      loginEyebrow: '目录 / 入口',
      registerEyebrow: '目录 / 新建',
      loginSection: '登录',
      registerSection: '注册',
      loginHeadTop: '欢迎回来',
      loginHeadAccent: '登录。',
      registerHeadTop: '开始使用',
      registerHeadAccent: '注册。',
      feature1: '一键接入',
      feature2: '稳定可靠',
      feature3: '按量计费',
      rights: '版权所有。',
  ...
  admin: {
    ...
    settings: {
      ...
      registration: {
        ...
        invitationCodeBuyUrl: '获取邀请码链接',
        invitationCodeBuyUrlPlaceholder: 'https://example.com/buy',
        invitationCodeBuyUrlHint: '在注册页面邀请码输入框旁显示一个跳转链接，引导用户去购买/获取邀请码（留空则不显示）',
        passwordReset: '忘记密码',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 NovaAPI 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 NovaAPI 用户登录',
