export default {
    settings: {
      ...
      registration: {
        ...
        invitationCodeBuyUrl: 'Get Invitation Code Link',
        invitationCodeBuyUrlPlaceholder: 'https://example.com/buy',
        invitationCodeBuyUrlHint: 'Show a link next to the invitation code field on the registration page, guiding users to purchase/obtain a code (leave empty to hide)',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on NovaAPI orders; the upstream type is sent as EasyPay type.',
