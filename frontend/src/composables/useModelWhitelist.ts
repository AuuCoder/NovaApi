...
const grokPresetMappings = [
  ...
  { label: 'Imagine Lite', from: 'grok-imagine-image-lite', to: 'grok-imagine-image-lite', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
